...
//    记录暂停音乐时进度条的位置
    ...
    protected void onCreate(Bundle savedInstanceState) {
        //ImageView welcome_gif = (ImageView) findViewById(R.id.local_music_bottom_iv_icon);
       // Glide.with(this).load(R.drawable.changpian2).into(welcome_gif);
...
//                从暂停到播放
            ...
            playIv.setImageResource(R.mipmap.btn_audio_pause_normal);
        }
    }
    private void pauseMusic() {
        ...
        if (mediaPlayer!=null&&mediaPlayer.isPlaying()) {
            ...
            mediaPlayer.pause();
            playIv.setImageResource(R.mipmap.btn_audio_play_normal);
        }
    }
